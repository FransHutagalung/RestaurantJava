...
public static int run = 0 ;
    ...
    private void initComponents() {
        ...
        curvesPanel1.setForeground(new java.awt.Color(102, 255, 255));

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\ACER\\Downloads\\koki23-removebg-preview.png")); // NOI18N

        lbStatus.setFont(new java.awt.Font("Tw Cen MT", 1, 14)); // NOI18N
        ...
        curvesPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, curvesPanel1Layout.createSequentialGroup()
                ...
                .addComponent(pro, javax.swing.GroupLayout.PREFERRED_SIZE, 329, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(237, 237, 237))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, curvesPanel1Layout.createSequentialGroup()
                ...
                .addGroup(curvesPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, curvesPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(328, 328, 328))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, curvesPanel1Layout.createSequentialGroup()
                        .addComponent(lbStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(303, 303, 303))))
        );
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    doTask("Mendapatkan Data Anda ...", 10);
                    doTask("Mendapatkan Data Anda...", 20);
                    doTask("Menyiapkan Data Makanan ...", 30);
                    doTask("Menyiapkan Data Makanan ...", 40);
                    doTask("Menyiapkan Data Makanan ...", 50);
                    doTask("Memproses Menu Utama ...", 60);
                    doTask("Memproses Menu Utama ...", 70);
                    doTask("Mengecek Validasi Akun ...", 80);
                    doTask("Mengecek Validasi Akun ...", 90);
                    doTask("Mengecek Validasi Akun ...", 100);
                    doTask("Selesai ...", 100);
